...
DEVICE_ONLINE_TIME_LIMIT_IN_SECONDS = config('DEVICE_ONLINE_TIME_LIMIT_IN_SECONDS')
DEVICE_OFFLINE_TIME_LIMIT_IN_SECONDS = config('DEVICE_OFFLINE_TIME_LIMIT_IN_SECONDS')

# this secret_key authenticates the device ,see .env.example file for more explanation
SECRET_KEY_FOR_DEVICE_TO_ACCESS_SERVER = config('SECRET_KEY_FOR_DEVICE_TO_ACCESS_SERVER')
